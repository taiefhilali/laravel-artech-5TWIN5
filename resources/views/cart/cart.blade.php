	 ...
	 <div class="col-md-8">
	  ...
	  <div class="cart_3l1 mt-3 row ms-0 me-0">
	   <div class="col-md-3 ps-0 col-3">
	    <div class="cart_3l1i">
		 <a href="#"><img src="{{Vite::asset('resources/assetsfront/img/img1.jpg')}}" alt="abc" class="w-100"></a>		</div>
	   </div>
 ...
 <div class="container-fluid">
   ...
   <div class="row footer_2 mt-4 text-center">
    <div class="col-md-12">
	 ...
	 <p class="mb-0">© 2023 Your Website Name. All Rights Reserved | Design by <a class="col_pink" href="http://www.templateonweb.com">ArTech</a></p>
	</div>
   </div>
 </div>
</section>
