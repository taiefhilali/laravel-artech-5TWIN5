...
<div class="table-responsive">
    ...
    <div class="content-body">
        ...
        <section id="catalog" class="row grid-view">
            @foreach ($catalogs as $catalogCard)
                <div class="col-md-4 mb-4">
                    <div class="card ecommerce-card" style="height: 100%;">
                        ...
                        <div class="card-body">
                            <div class="item-name">
                                <a href="app-ecommerce-details.html">{{ $catalogCard->name }}</a>
                            </div>
                            <p class="card-text item-description">
                                {{ $catalogCard->description }}
                            </p>
                        </div>
                        <div class="item-options text-center" style="margin-bottom: 10px;">
                        <a class="btn btn-light btn-wishlist remove-wishlist" href="{{ url('/admin/catalog/' . $catalogCard->id. '/edit') }}">
...
{{-- <script>
        ...
        @vite(['resources/assetsback/css/pages/app-ecommerce.css'])
