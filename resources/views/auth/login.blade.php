...
<head>
    ...
    <title>Login Page - ArTech</title>
    <link rel="apple-touch-icon" href="{{ Vite::asset('resources/assetsback/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ Vite::asset('resources/assetsback/images/ico/favicon.ico')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/assetsback/css/plugins/forms/form-validation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/assetsback/css/pages/authentication.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ Vite::asset('resources/assetsback/images/pages/login-v2.svg')}}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ Vite::asset('resources/assetsback/js/scripts/pages/auth-login.js')}}"></script>
    <!-- END: Page JS-->
