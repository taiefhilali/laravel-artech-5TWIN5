...
<div class="auth-inner row m-0">
    ...
    <!-- /Brand logo-->
    <!-- Left Text-->
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5" style="background-color:#f4f4f4">
        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid"
                src="{{ Vite::asset('resources/assetsback/images/pages/login-v2.svg')}}" alt="login V2" /></div>
    </div>

  <!-- /Left Text-->
    <!-- Register-->
  <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5" style="background-color:#f4f4f4">
        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto" style="background-color:#f4f4f4" >

        <x-guest-layout>
            
        <h2 class="card-title fw-bold mb-1">Welcome to Artech! 👋</h2>
    ...
    <x-primary-button style="background-color:#7367f0; height: 40px;">
  {{ __('Log in') }}
    </x-primary-button>
</div>
    ...
    <a href="{{ route('register') }}"><span style="color:#a39ed3">&nbsp;Create an account</span></a>
</p>
